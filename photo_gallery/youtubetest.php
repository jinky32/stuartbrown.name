...
$playlists_url="https://www.googleapis.com/youtube/v3/playlists?part=id,snippet,status,contentDetails&channelId=".$youtube->v3UserId."&key=AIzaSyCkLQdmPsuH_Ce3qXbMkX6z-p_t4EX4aoM";
//print $playlists_url;
