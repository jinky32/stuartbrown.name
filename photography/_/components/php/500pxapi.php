...
//I NEED TO REPLACE $SITECATEGORIES BELOW WITH $CATARRAY_DATABSE FROM 500PXHARDCODED.PHP. HOWEVER I NEED TO MAKE CAT_ID THE KEY IN THE LATTER DB
//SO THAT I CAN USE ARRAY_INTERSECT_KEY (AS BELOW)
