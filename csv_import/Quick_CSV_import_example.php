...
//connect to database
mysql_connect("mysql.stuartbrown.name", "stuartbrown", "m4nch3st3r");
mysql_select_db("csvimport"); //your database
...
if(isset($_POST["Go"]) && ""!=$_POST["Go"]) //form was submitted
{
  ...
  $csv->table_name = $_POST["set_table"];
  ...
  <form method="post" enctype="multipart/form-data">
    <table border="0" align="center">
      <tr>
       ...
       <tr>
        <td>Set Table:</td>
        <td><input type="text" name="set_table" id="set_table"/></td>
      </tr>
      <tr>
